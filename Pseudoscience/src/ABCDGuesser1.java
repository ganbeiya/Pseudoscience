...
public final class ABCDGuesser1 {
     ...
     */
    //FIXME: fix all the warnings before submission
    private static double getPositiveDouble(SimpleReader in, SimpleWriter out) {
        String snm = in.nextLine(); //receive the constant μ

        boolean result = FormatChecker.canParseDouble(snm);
        //FIXME（finished): takes 0 as input.
    ...
    private static double getPositiveDoubleNotOne(SimpleReader in,
        ...
        //FIXME(finished): takes 0 as input. 1.0000001 is valid, but doesn't take it.
        while (!result || Double.parseDouble(snm) <= 0
